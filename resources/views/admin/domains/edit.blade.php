  ...
  <div class="w-full lg:w-2/3">
    ...
    <div class="bg-(--panel) shadow-sm rounded-2xl p-6 border border-(--border-strong)">
      <div class="flex items-center justify-between mb-6">
        <div>
          <h5 class="font-semibold text-base md:text-lg mb-0 text-(--text)">Edit</h5>
          <div class="text-(--muted) text-xs md:text-sm">Ubah data domain/aspek/indikator.</div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div class="md:col-span-9">
            ...
            <input type="text" name="nama_domain"
                   ...
                   value="{{ old('nama_domain', $domain->nama_domain) }}" required>
          ...
          <div class="md:col-span-6">
            ...
            <input type="text" name="nama_aspek"
                   ...
                   value="{{ old('nama_aspek', $domain->nama_aspek) }}" required>
          ...
          <div class="md:col-span-6">
            ...
            <input type="text" name="nama_indikator"
                   ...
                   value="{{ old('nama_indikator', $domain->nama_indikator) }}" required>
